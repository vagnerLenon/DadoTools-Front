...
import GestaoInbox from '~/pages/Apps/Tickets/Gestao/Inbox';
import GestaoEnviados from '~/pages/Apps/Tickets/Gestao/Enviados';
import GestaoConcluidos from '~/pages/Apps/Tickets/Gestao/Concluidos';
import GestaoHistorico from '~/pages/Apps/Tickets/Gestao/Historico';
