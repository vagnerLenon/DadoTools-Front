...
function Despesas() {
  ...
  useEffect(() => {
    async function AtualizaDados() {
      const { data } = await api.get('configs/despesas');
      setDados(data.despesas.json_obj);
    }
    AtualizaDados();
  }, []);
  ...
  return (
    <Container>
      <strong>
        Despesas de venda são valores percentuais que serão abatidos da receita
        total do período simulado
      </strong>
